        ...
        <div className="grid gap-4">
          {filteredContent.map((item: any) => (
            <Card
              ...
              onClick={() => { setSelectedContentId(item.id); setSheetOpen(true); }}
            >
    ...
    <DashboardLayout>
      <div className="container py-8">
        ...
        <div className="mb-8 flex items-center justify-between gap-4">
          <div>
            <h1 className="text-3xl font-bold mb-2">Apex Content</h1>
            <p className="text-muted-foreground">Review approvals and manage your AI-generated content</p>
          </div>
        </div>
