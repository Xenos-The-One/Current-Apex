...
async function startServer() {
  ...
  // ⚠️ CRITICAL: Stripe webhook MUST be registered with express.raw() BEFORE
  // the global express.json() middleware. Stripe signature verification requires
  // the raw request body — once json() parses it, the signature check fails.
  app.post(
    "/api/stripe/webhook",
